...
const controllerFlowMessagesByLocale = {
  ...
  es: {
    stickDrift: {
      sampleLabel: 'Muestra de 3 segundos',
      sampleComplete: 'Muestra de 3 segundos completada',
      plotScale: 'radio del 20 %',
      readyInstruction: 'Suelta ambos sticks y no los toques.',
      samplingInstruction: 'Mantén ambos sticks sin tocar durante 3 segundos.',
      testingButton: 'Probando…',
      mappingLimitation: 'El test de drift requiere el mapeo estándar de gamepad del navegador. Este gamepad no se mide porque, de otro modo, habría que adivinar los ejes físicos de los sticks.',
      mappingInstruction: 'Selecciona un gamepad con mapeo estándar para ejecutar el test de drift.',
      mappingSummary: 'El test de drift no está disponible para el gamepad seleccionado porque no expone un mapeo estándar completo.',
      cancelledInstruction: 'Suelta ambos sticks e inicia de nuevo cuando el gamepad esté listo.',
      noSamples: 'No se capturaron muestras utilizables de los sticks. Inicia el test de nuevo.',
      noSamplesInstruction: 'No se capturaron muestras utilizables de los sticks. Inicia de nuevo.',
      noSamplesSummary: 'El test de drift se canceló porque no se capturaron muestras utilizables.',
      resultInstruction: 'Se muestra el desplazamiento de centro observado para cada stick.',
      accessLost: 'El acceso al gamepad dejó de estar disponible durante la muestra.',
      disconnected: 'El gamepad se desconectó durante la muestra.',
      selectedDisconnected: 'El gamepad seleccionado se desconectó durante la muestra.',
      mappingLost: 'El gamepad seleccionado ya no puede proporcionar los ejes estándar de los sticks.',
      pageHidden: 'La página se ocultó durante la muestra.',
      stopped: 'La medición se detuvo antes de completar la muestra.',
    },
    deadzone: {
      sampleLabel: 'Muestra de 3 segundos',
      sampleComplete: 'Muestra de 3 segundos completada',
      centerDetailScale: 'Detalle del centro · radio del 20 %',
      leftChoice: 'Izquierdo',
      rightChoice: 'Derecho',
      readyInstructionLeft: 'Suelta el stick izquierdo y no lo toques.',
      readyInstructionRight: 'Suelta el stick derecho y no lo toques.',
      samplingInstructionLeft: 'Mantén el stick izquierdo sin tocar durante 3 segundos.',
      samplingInstructionRight: 'Mantén el stick derecho sin tocar durante 3 segundos.',
      testingButton: 'Probando…',
      mappingLimitation: 'La medición de zona muerta requiere el mapeo estándar de gamepad del navegador. Este gamepad no se mide porque, de otro modo, habría que adivinar los ejes físicos de los sticks.',
      mappingInstruction: 'Selecciona un gamepad con mapeo estándar para medir el ruido alrededor del centro.',
      mappingSummary: 'El test de zona muerta no está disponible para el gamepad seleccionado porque no expone un mapeo estándar completo.',
      cancelledInstructionLeft: 'Suelta el stick izquierdo e inicia de nuevo cuando el gamepad esté listo.',
      cancelledInstructionRight: 'Suelta el stick derecho e inicia de nuevo cuando el gamepad esté listo.',
      noSamples: 'No se capturaron muestras utilizables del stick. Inicia el test de nuevo.',
      noSamplesInstruction: 'No se capturaron muestras utilizables del stick. Inicia de nuevo.',
      noSamplesSummary: 'El test de zona muerta se canceló porque no se capturaron muestras utilizables.',
      resultInstruction: 'Se muestran el ruido de centro observado y una zona muerta inicial heurística.',
      accessLost: 'El acceso al gamepad dejó de estar disponible durante la muestra.',
      disconnected: 'El gamepad se desconectó durante la muestra.',
      selectedDisconnected: 'El gamepad seleccionado se desconectó durante la muestra.',
      mappingLost: 'El gamepad seleccionado ya no puede proporcionar los ejes estándar de los sticks.',
  ...
  ru: {
    stickDrift: {
      sampleLabel: '3-секундная выборка',
      sampleComplete: '3-секундная выборка завершена',
      plotScale: 'радиус 20 %',
      readyInstruction: 'Отпустите оба стика и не трогайте их.',
      samplingInstruction: 'Не трогайте оба стика в течение 3 секунд.',
      testingButton: 'Тест выполняется…',
      mappingLimitation: 'Для теста дрифта нужен стандартный браузерный маппинг геймпада. Этот геймпад не измеряется, потому что иначе пришлось бы угадывать физические оси стиков.',
      mappingInstruction: 'Выберите геймпад со стандартным маппингом, чтобы запустить тест дрифта.',
      mappingSummary: 'Тест дрифта недоступен для выбранного геймпада, потому что он не предоставляет полный стандартный маппинг.',
      cancelledInstruction: 'Отпустите оба стика и запустите снова, когда геймпад будет готов.',
      noSamples: 'Не удалось получить пригодные выборки стиков. Запустите тест снова.',
      noSamplesInstruction: 'Пригодные выборки стиков не получены. Запустите снова.',
      noSamplesSummary: 'Тест дрифта отменён, потому что пригодные выборки не были получены.',
      resultInstruction: 'Для каждого стика показано наблюдаемое смещение центра.',
      accessLost: 'Во время выборки доступ к геймпаду стал недоступен.',
      disconnected: 'Геймпад отключился во время выборки.',
      selectedDisconnected: 'Выбранный геймпад отключился во время выборки.',
      mappingLost: 'Выбранный геймпад больше не предоставляет стандартные оси стиков.',
      pageHidden: 'Страница стала скрытой во время выборки.',
      stopped: 'Измерение было остановлено до завершения выборки.',
    },
    deadzone: {
      sampleLabel: '3-секундная выборка',
      sampleComplete: '3-секундная выборка завершена',
      centerDetailScale: 'Детали центра · радиус 20 %',
      leftChoice: 'Левый',
      rightChoice: 'Правый',
      readyInstructionLeft: 'Отпустите левый стик и не трогайте его.',
      readyInstructionRight: 'Отпустите правый стик и не трогайте его.',
      samplingInstructionLeft: 'Не трогайте левый стик в течение 3 секунд.',
      samplingInstructionRight: 'Не трогайте правый стик в течение 3 секунд.',
      testingButton: 'Тест выполняется…',
      mappingLimitation: 'Для измерения мёртвой зоны нужен стандартный браузерный маппинг геймпада. Этот геймпад не измеряется, потому что иначе пришлось бы угадывать физические оси стиков.',
      mappingInstruction: 'Выберите геймпад со стандартным маппингом, чтобы измерить шум около центра.',
      mappingSummary: 'Тест мёртвой зоны недоступен для выбранного геймпада, потому что он не предоставляет полный стандартный маппинг.',
      cancelledInstructionLeft: 'Отпустите левый стик и запустите снова, когда геймпад будет готов.',
      cancelledInstructionRight: 'Отпустите правый стик и запустите снова, когда геймпад будет готов.',
      noSamples: 'Не удалось получить пригодные выборки стика. Запустите тест снова.',
      noSamplesInstruction: 'Пригодные выборки стика не получены. Запустите снова.',
      noSamplesSummary: 'Тест мёртвой зоны отменён, потому что пригодные выборки не были получены.',
      resultInstruction: 'Показаны наблюдаемый шум около центра и эвристическая стартовая мёртвая зона.',
      accessLost: 'Во время выборки доступ к геймпаду стал недоступен.',
      disconnected: 'Геймпад отключился во время выборки.',
      selectedDisconnected: 'Выбранный геймпад отключился во время выборки.',
      mappingLost: 'Выбранный геймпад больше не предоставляет стандартные оси стиков.',
