...
The full-v1 catalog, Hardware Expansion 1, localization, and the Hardware Expansion V2 Foundation are **code-side complete and audited**. Expansion V2 is shipping in atomic production-valid waves; Printer Test Page, Monitor Test, and Screen Uniformity Test are the first three V2 jobs added after Foundation.
...
Implemented diagnostic routes after the Screen Uniformity wave:
...
`23_HARDWARE_EXPANSION_V2_SPEC.md` owns V2 jobs such as Printer Test Page, Monitor Test, and Screen Uniformity Test. `22_LOCALIZATION_SPEC.md` still owns locale routing/canonical/hreflang architecture and does not override diagnostic or capability semantics.
